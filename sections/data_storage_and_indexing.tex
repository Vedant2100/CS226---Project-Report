...
\begin{itemize}
    ...
    \begin{itemize}
        \item Stored in cloud object storage (AWS S3).
...
\end{itemize}
Stored in PostgreSQL with PostGIS indexing. Queried using SQL for spatiotemporal filtering. Powers downstream analytics like time series extraction and anomaly detection.
