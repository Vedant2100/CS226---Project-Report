...
\begin{itemize}
    ...
    I contributed to the initial research on dataset sources and experimented with timelapse generation. I established the project repositories and reports, and played a key role in designing and implementing the data transformation pipeline, the evaluation framework, and the generation of output products. I also proposed the study area for the pipeline and coordinated the integration of results and documentation across the team.
